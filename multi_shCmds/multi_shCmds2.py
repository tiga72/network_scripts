...
def main():
    for dev in open("C:\\Users\\limengse\\scripts\\rw\\dev_list.txt", "r"): 
        ...
        crt.Screen.Send("ssh -oKexAlgorithms=diffie-hellman-group14-sha1 limengse@" + dev + "\n")
        ...
        crt.Screen.WaitForString("$") # Waits for 2 dev message "Connection to xxx closed" to be done
